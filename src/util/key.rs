...
impl PublicKey {
    ...
    /// Computes the public key as supposed to be used with this secret
    pub fn from_private_key2(sk: &PrivateKey) -> PublicKey {
...
impl PrivateKey {
    ...
    pub fn sign<C: secp256k1::Signing>(&self, msg: &secp256k1::Message,secp: &Secp256k1<C>) -> Vec<u8> {
        let signature = secp.sign(
            msg,
            &self.key,
        );
        return signature.serialize_der();
    }
